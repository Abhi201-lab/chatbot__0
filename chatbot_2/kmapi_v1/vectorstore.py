...
class PGVectorRetriever:
    def __init__(self, database_url: str):
        ...
        # do not create tables here (ingestion handles); just verify extension lazily
    ...
    def similarity_search(self, query_emb: list[float], k: int = 4) -> List[Tuple[str, float, str, str]]:
        ...
        try:
            ...
            # Build pgvector array literal manually to avoid psycopg2 binding to numeric[] which breaks <=> operator
